 ...
 */
final class Version20231108183038 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_B6A99CEBA76ED395 ON culture');
        $this->addSql('ALTER TABLE culture DROP user_id, CHANGE category_id category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE culture ADD user_id INT DEFAULT NULL, CHANGE category_id category_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_B6A99CEBA76ED395 ON culture (user_id)');
    }
}
