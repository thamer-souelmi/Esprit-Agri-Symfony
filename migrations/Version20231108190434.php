 ...
 */
final class Version20231108190434 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE culture CHANGE user_id category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE culture CHANGE category_id user_id INT DEFAULT NULL');
